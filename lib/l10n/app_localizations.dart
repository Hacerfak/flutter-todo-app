...
abstract class AppLocalizations {
  ...
  /// No description provided for @olaMundo.
  ///
  ...
  /// No description provided for @erroDescricao.
  ///
  /// In pt, this message translates to:
  /// **'Por favor, informe a descrição.'**
  String get erroDescricao;
  ...
  /// No description provided for @excluirItem.
  ///
  /// In pt, this message translates to:
  /// **'Excluir item'**
  String get excluirItem;

  /// No description provided for @excluirItens.
  ///
  /// In pt, this message translates to:
  /// **'Excluir itens'**
  String get excluirItens;

  /// No description provided for @excluirTodosItens.
  ///
  /// In pt, this message translates to:
  /// **'Deseja excluir todos os itens?'**
  String get excluirTodosItens;
  ...
  ///
  /// In pt, this message translates to:
  /// **'Criado por: Eder Gross Cichelero'**
  String get dev;
  ...
  /// No description provided for @alterar.
  ///
  /// In pt, this message translates to:
  /// **'Alterar'**
  String get alterar;

  /// No description provided for @confirmarExclusao.
  ///
  /// In pt, this message translates to:
  /// **'Deseja excluir o item {tituloExluido}?'**
